...
class FCN8s(nn.Module):
    ...
    def forward(self, x):
        h = x
        #print("network input size = ", h.shape)
        ...
        #print("h[%d][%d][5~%d][5~%d]" %(h.size()[0],h.size()[1],upscore2.size()[2],upscore2.size()[3]))
        #print(h.shape)
        score_pool4c = h  # 1/16
        ...
        #print("h[%d][%d][9~%d][9~%d]" %(h.size()[0],h.size()[1],upscore_pool4.size()[2],upscore_pool4.size()[3]))
        #print(h.shape)
        ...
        #print("H[%d][%d][31~%d][31~%d]" %(h.size()[0],h.size()[1],x.size()[2],x.size()[3]))
        #print(h.shape)
