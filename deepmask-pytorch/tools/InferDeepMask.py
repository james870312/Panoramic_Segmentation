...
class Infer(object):
    ...
    def forward(self, img):
        ...
        for inp in imgPyramid:
            ...
            #test=outMask.cpu().detach()
            #test = test.permute(1,2,3,0)
            #test = test.numpy()
            #plt.imshow(test[1])
            #plt.show()
            ...
            #print(self.mHead)
            #print(self.sHead)
            #print(np.shape(imgPad))
            #print(np.shape(outTrunk))
            #print(np.shape(outMask))
            #print(np.shape(outScore))
